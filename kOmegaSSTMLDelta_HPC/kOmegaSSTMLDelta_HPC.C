...
#include "kOmegaSSTMLDelta_HPC.H"
...
void kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::correctNut(const volScalarField& S2)
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::kOmegaSSTMLDelta_HPC
(
...
template<class BasicTurbulenceModel>
tmp<fvVectorMatrix> kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::divDevReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTMLDelta_HPC::divDevReff()" << endl;
    return
    (
...
kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::devRhoReff() const
{
    Info << "In: kOmegaSSTMLDelta_HPC::devRhoReff()" << endl;
...
kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTMLDelta_HPC::divDevRhoReff(U)" << endl;
    return
    (
...
{
    Info << "In: kOmegaSSTMLDelta_HPC::divDevRhoReff(rho, U)" << endl;
    return
    (
...
template<class BasicTurbulenceModel>
void kOmegaSSTMLDelta_HPC<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    }
    Info << "In: kOmegaSSTMLDelta_HPC.correct()" << endl;
    // Local references
