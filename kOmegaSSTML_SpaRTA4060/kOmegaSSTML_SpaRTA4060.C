...
#include "kOmegaSSTML_SpaRTA4060.H"
...
void kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::correctNut(const volScalarField& S2)
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::kOmegaSSTML_SpaRTA4060
(
...
template<class BasicTurbulenceModel>
tmp<fvVectorMatrix> kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::divDevReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTML_SpaRTA4060::divDevReff()" << endl;
    return
    (
...
kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::devRhoReff() const
{
    Info << "In: kOmegaSSTML_SpaRTA4060::devRhoReff()" << endl;
...
kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTML_SpaRTA4060::divDevRhoReff(U)" << endl;
    return
    (
...
{
    Info << "In: kOmegaSSTML_SpaRTA4060::divDevRhoReff(rho, U)" << endl;
    return
    (
...
template<class BasicTurbulenceModel>
void kOmegaSSTML_SpaRTA4060<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    }
    Info << "In: kOmegaSSTML_SpaRTA4060.correct()" << endl;
    // Local references
...
/*******************************Model Addition**************************/
    ...
    kDeficit_ = max(classifier * ((0.12786104 * (q_Re/0.41575212)*(G1_s/0.034100386) +
     0.84943972 * pow(Ak2/0.31776878 , 2)*(G1_s/0.034100386) + 
     11.812187 * tanh((AlfAkS_s/0.18737552))*(G1_s/0.034100386) + 
     7.5099664 * log( 1 + sqrt(pow(AlfAkS_s/0.18737552 , 2)))*(G1_s/0.034100386)) * 0.0061087373),
