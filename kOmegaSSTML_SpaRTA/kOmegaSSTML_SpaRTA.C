...
void kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::correctNut(const volScalarField& S2)
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::kOmegaSSTML_SpaRTA
(
...
template<class BasicTurbulenceModel>
tmp<fvVectorMatrix> kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::divDevReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTML_SpaRTA::divDevReff()" << endl;
    return
    (
...
kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::devRhoReff() const
{
    Info << "In: kOmegaSSTML_SpaRTA::devRhoReff()" << endl;
...
kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
    Info << "In: kOmegaSSTML_SpaRTA::divDevRhoReff(U)" << endl;
    return
    (
...
{
    Info << "In: kOmegaSSTML_SpaRTA::divDevRhoReff(rho, U)" << endl;
    return
    (
...
template<class BasicTurbulenceModel>
void kOmegaSSTML_SpaRTA<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    }
    Info << "In: kOmegaSSTML_SpaRTA.correct()" << endl;
    // Local references
